...
import type { ReportErrorCode } from '@/config/api/mutate'
...
import { ReportRefusedError } from '@/config/api/mutate'
 ...
 * `RegistrationForm` does. So ADDING a code to `ReportErrorCode` fails
 ...
 */
const REFUSAL_MESSAGE_KEYS: Record<ReportErrorCode, TranslationKey> = {
...
export function ReportIssueForm({
  ...
  // same spelling.
  const refusalKey =
    mutation.error instanceof ReportRefusedError &&
