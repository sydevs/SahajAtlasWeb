...
// Centers, led by an "Online Classes" roll-up; "Empty" is the no-events state.
const EXAMPLES = {
  Country: {
 ...
 * SY Centers (venues), led by an "Online Classes" roll-up; "Empty" is the no-events
 * state (unreachable in the app — getRegion 404s a 0-event region).
 */
