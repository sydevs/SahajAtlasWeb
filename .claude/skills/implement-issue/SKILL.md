...
- **Tests** — a fast node-only unit lane (`pnpm test:run`, co-located
  ...
  (schemas, stores, helpers, the SDK client's request context). For behavioral/UI
  changes the lane can't cover, verify in the running widget (Playwright MCP) and describe
